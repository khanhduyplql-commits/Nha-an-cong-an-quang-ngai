...
export const TableMapPOS: React.FC = () => {
  const { 
    tables, 
    orders, 
    serviceCalls, 
              ...
              >
                ...
                <div className="pt-3 mt-3 border-t border-stone-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    title="Mở chế độ khách tại bàn này"
                    className="p-1.5 rounded-lg bg-stone-100 hover:bg-amber-100 hover:text-amber-700 text-stone-500 transition-colors cursor-pointer"
                  >
          ...
          <div className="w-full max-w-lg bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh] border border-stone-200">
            ...
            <div className="p-4 sm:p-5 border-t border-stone-200 bg-stone-50 flex flex-wrap items-center justify-between gap-2">
              <button
                ...
                className="px-3.5 py-2.5 rounded-xl border border-red-300 bg-red-50 hover:bg-red-100 text-red-700 text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer"
              >
                <RotateCcw className="w-3.5 h-3.5" />
                <span>Xóa Phiên / Dọn Bàn</span>
              </button>
